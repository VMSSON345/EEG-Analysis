...
def extract_features_hmm(base_data_path, output_dir):
    ...
    EXCLUDE_SUBS = ['sub-02', 'sub-07', 'sub-08', 'sub-10', 'sub-16', 'sub-23', 'sub-25', 'sub-35']
    ...
    for sub_id in all_targets:
        ...
        psds, freqs = psd_array_welch(full_data, sfreq=epochs.info['sfreq'],
                                      fmin=0.5, fmax=30.0, n_fft=256, verbose='ERROR')
...
if __name__ == "__main__":
    DATA_DIR = './data/0.5-30'
    OUTPUT_DIR = './features/0.5-30'
